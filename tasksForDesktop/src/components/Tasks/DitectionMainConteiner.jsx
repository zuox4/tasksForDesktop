			...
			<div className={styles.directionMainConteiner}>
				...
				<div className={styles.infoBlock}>
					<div className={styles.leftside}>
						...
						<button
							className={styles.sendbuttontocategory}
							onClick={() =>
								dispatch(changefilterTaksValue(categories[categotyId].title))
							}
					...
					<div className={styles.rigthside}>
						<img
							...
							src={categories[categotyId].url_icon}
							alt=''
						/>
					</div>
				</div>
				...
				<button
					...
					onClick={() =>
						categotyId < categories.length - 1 &&
