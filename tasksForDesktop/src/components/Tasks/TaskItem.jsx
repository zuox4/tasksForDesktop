            ...
            <div style={{margin:'15px'}} className=''>
                ...
                <div style={{display:'flex', flexDirection:'row', justifyContent:'space-between'}}>
                    <div style={{display:'flex', flexDirection:'column', gap:'15px', marginTop:"10px"}}>
                        ...
                        <span style={{textAlign:'left', width:'100%'}}>{item.description}</span>
                    ...
                    <div style={{display:'flex', flexDirection:'column',justifyContent:'space-around', alignItems:'flex-end'}}>
                        {openTasks.includes(item.id)&&<div style={{ fontWeight:'500', padding:'8px 10px', background:'rgb(255 212 0 / 32%)', borderRadius:'10px'}}>Ожидает вашего выполнения</div>}
